                ...
                <div className="flex gap-2 md:gap-4 items-center relative">
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        {isInstallable && (
                            <button 
                                onClick={installApp}
                                className="group flex items-center gap-3 px-5 py-2.5 rounded-full text-xs font-bold bg-transparent border border-zen-accent/30 text-zen-accent hover:bg-zen-accent hover:text-black transition-all duration-300 hover:shadow-glow-cyan backdrop-blur-md"
                            >
                    ...
                    {showMobileMenu && (
                        <div className="absolute top-full right-0 mt-4 w-64 bg-white/95 dark:bg-[#121212]/95 backdrop-blur-2xl border border-gray-200 dark:border-white/10 rounded-3xl shadow-2xl p-4 z-50 animate-fade-in origin-top-right md:hidden">
                            <div className="flex flex-col gap-2">
                                {isInstallable && (
                                    <button 
                                        onClick={() => { installApp(); setShowMobileMenu(false); }}

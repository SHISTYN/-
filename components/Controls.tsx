...
const LiquidInput: React.FC<{ 
    ...
    return (
        <div className="flex flex-col w-full gap-2 group">
            ...
            <div className="relative flex items-stretch w-full h-20 rounded-3xl overflow-hidden shadow-lg transition-all duration-300 bg-[#0a0a0b]/80 backdrop-blur-xl group-hover:shadow-[0_0_30px_-10px_rgba(255,255,255,0.1)] border border-white/10 ring-1 ring-white/5">
                ...
                <button 
                    {...minusLongPress}
                    className="relative z-10 w-14 flex items-center justify-center bg-transparent hover:bg-white/5 active:bg-white/10 transition-colors border-r border-white/5"
                >
                ...
                <div className="relative z-10 flex-1 flex flex-col items-center justify-center overflow-hidden">
                    ...
                    {subLabel && <span className="absolute bottom-2 text-[8px] font-bold text-zinc-500 uppercase pointer-events-none">{subLabel}</span>}
                </div>

                {/* Plus Button */}
                <button 
                    {...plusLongPress}
                    className="relative z-10 w-14 flex items-center justify-center bg-transparent hover:bg-white/5 active:bg-white/10 transition-colors border-l border-white/5"
                >
                                    ...
                                    {pattern.presets?.map((p, idx) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-full text-left px-4 py-3 rounded-2xl mb-1 flex items-center justify-between transition-all group ${
                                                    isActive 

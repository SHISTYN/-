    ...
    <div className="relative flex items-center justify-center select-none" style={{ width: SIZE, height: SIZE }}>
        ...
        >
            ...
            >
                ...
                <div className="absolute inset-0 opacity-80 mix-blend-screen blur-[50px]">
                    {/* Orb 1: Primary */}
                    <motion.div 
                    ...
                    {/* Orb 2: Secondary */}
                    <motion.div 
                        className="absolute bottom-[-20%] right-[-20%] w-[90%] h-[90%] rounded-full"
                        animate={{ 
                    ...
                    {/* Orb 3: Highlight */}
                    <motion.div 
                        className="absolute top-[20%] left-[20%] w-[60%] h-[60%] rounded-full opacity-60"
                        animate={{ 
